...
description: >-
  Use whenever adding, fixing, extending, or reviewing any UI in this School ERP
  app — new pages, design, functionality, tables, roles, forms, text
  fields, toggles, app bars, loading/skeleton states, accordions, search bars,
  or general UI polish, all the implemetation. Also trigger on vaguer signals like "the UI looks
  broken/messed up," "make this screen nicer," or "add a loading state" —
  these usually resolve to one of the llm context file conventions below.
---
