...
async function expectRejected(operation: () => Promise<unknown>) {
  await expect(operation()).rejects.toThrow(
    /tenant|organization|campus|scope|status|capacity/i,
  );
}
...
describe("database tenant integrity", () => {
    ...
    await client.batch([
      {
        ...
        args: ["org-a", "School A", "school-a", now, now, "active"],
      },
      {
        sql: "INSERT INTO organizations (id, name, slug, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?)",
        args: ["org-b", "School B", "school-b", now, now, "active"],
      },
      {
        sql: "INSERT INTO campuses (id, organization_id, name, code, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?)",
        args: ["campus-a", "org-a", "Main", "MAIN", now, now, "active"],
      },
      {
        sql: "INSERT INTO campuses (id, organization_id, name, code, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?)",
        args: ["campus-b", "org-b", "Main", "MAIN", now, now, "active"],
      },
      {
        sql: "INSERT INTO classes (id, organization_id, name, code, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?)",
        args: ["class-a", "org-a", "Grade 8", "G8", now, now, "active"],
      },
      {
        sql: "INSERT INTO sections (id, organization_id, class_id, name, capacity, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: ["section-a", "org-a", "class-a", "A", 40, now, now, "active"],
      },
      {
        sql: "INSERT INTO users (id, firebase_uid, organization_id, email, display_name, role, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "user-a",
          "firebase-a",
          "org-a",
  ...
  it("guards Razorpay provider orders by invoice scope, balance and one active attempt", async () => {
    ...
    await client.execute({
      sql: "INSERT INTO payment_provider_orders (id, organization_id, campus_id, provider, invoice_id, student_id, amount_minor, currency, receipt, idempotency_key, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
      args: [
        "provider-order-a",
        "org-a",
        "campus-a",
    ...
    await expect(
      client.execute({
        ...
        args: [
          ...
          "INR",
          "serp_provider_over",
          "provider-attempt-over",
          now,
          now,
          "failed",
        ],
      }),
    ).rejects.toThrow(/scope|amount/i);
    await expect(
      client.execute({
        sql: "INSERT INTO payment_provider_orders (id, organization_id, campus_id, provider, invoice_id, student_id, amount_minor, currency, receipt, idempotency_key, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
    ...
    await expect(
      client.execute({
        sql: "UPDATE payment_provider_orders SET amount_minor = 4000 WHERE id = ?",
        args: ["provider-order-a"],
      }),
  ...
  it("rejects cross-tenant library copies and issue transactions", async () => {
    await client.batch([
      {
        sql: "INSERT INTO library_items (id, organization_id, campus_id, title, total_copies, available_copies, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "library-item-a",
          "org-a",
          "campus-a",
  ...
  it("keeps inventory movements tenant-scoped and quantities non-negative", async () => {
    ...
    await expect(
      client.execute({
        ...
        args: [-1, "inventory-item-a"],
      }),
    ).rejects.toThrow(/negative|inventory/i);
  });
  ...
  it("keeps transport allocations tenant-scoped and prevents duplicate active allocation", async () => {
    await client.batch([
      ...
      {
        sql: "INSERT INTO transport_routes (id, organization_id, campus_id, name, capacity, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "route-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO transport_stops (id, organization_id, campus_id, name, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?)",
        args: ["stop-a", "org-a", "campus-a", "Stop A", now, now, "active"],
      },
      {
      ...
      {
        sql: "INSERT INTO vehicles (id, organization_id, campus_id, registration_number, type, capacity, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "vehicle-a",
          "org-a",
          "campus-a",
  ...
  it("keeps employees and payroll snapshots tenant-scoped", async () => {
    await client.batch([
      ...
      {
        sql: "INSERT INTO payroll_runs (id, organization_id, campus_id, period, total_minor, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "payroll-a",
          "org-a",
          "campus-a",
  ...
  it("enforces hostel bed scope, one active allotment, and room capacity", async () => {
    await client.batch([
      ...
      {
        sql: "INSERT INTO hostel_rooms (id, organization_id, campus_id, building, room_number, capacity, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "room-a",
          "org-a",
          "campus-a",
  ...
  it("keeps asset lifecycle records tenant-scoped and assignment-safe", async () => {
    await client.batch([
      {
        sql: "INSERT INTO assets (id, organization_id, campus_id, name, code, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "asset-a",
          "org-a",
          "campus-a",
          "Laptop",
          "ASSET-A",
          '{"category":"IT","acquisitionMinor":1000,"bookValueMinor":1000,"usefulLifeMonths":36}',
          now,
          now,
          "active",
        ],
    ...
    await expectRejected(() =>
      client.execute({
        ...
        args: ["published", "asset-a"],
      }),
    );
  });

  it("keeps safety and facilities workflows tenant-scoped", async () => {
    const approvedStart = new Date(now + 3_600_000).toISOString();
    const approvedEnd = new Date(now + 7_200_000).toISOString();
    const overlappingStart = new Date(now + 5_400_000).toISOString();
    const overlappingEnd = new Date(now + 9_000_000).toISOString();
    await client.batch([
      {
        sql: "INSERT INTO visitor_logs (id, organization_id, campus_id, name, effective_at, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "visitor-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO security_incidents (id, organization_id, campus_id, name, effective_at, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "incident-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO evacuation_roll_calls (id, organization_id, campus_id, name, effective_at, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "evacuation-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO facility_bookings (id, organization_id, campus_id, name, effective_at, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "booking-a",
          "org-a",
          "campus-a",
      ...
      },
      {
        ...
        args: [
          ...
          "Auditorium",
          now,
          JSON.stringify({ startsAt: approvedStart, endsAt: approvedEnd }),
          now,
          now,
          "approved",
        ],
      ...
      {
        sql: "INSERT INTO facility_maintenance_tickets (id, organization_id, campus_id, name, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "facility-ticket-a",
          "org-a",
          "campus-a",
    ...
    await expect(
      client.execute({
        sql: "UPDATE facility_bookings SET status = ? WHERE id = ?",
        args: ["approved", "booking-overlap"],
      }),
    ).rejects.toThrow(/overlap/i);
    await expectRejected(() =>
      client.execute({
        sql: "UPDATE security_incidents SET status = ? WHERE id = ?",
        args: ["published", "incident-a"],
      }),
    );
  });

  it("enforces webhook event identity atomically", async () => {
    await client.execute({
      sql: "INSERT INTO webhook_events (id, organization_id, campus_id, name, code, reference_id, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
      args: [
        "webhook-a",
        "org-a",
        "campus-a",
  ...
  it("keeps community and CMS records tenant-scoped and publication-safe", async () => {
    await client.batch([
      {
        sql: "INSERT INTO clubs (id, organization_id, campus_id, name, coordinator_user_id, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "club-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO sports_teams (id, organization_id, campus_id, name, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "team-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO alumni_profiles (id, organization_id, campus_id, student_id, name, graduation_year, directory_visible, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "alumni-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO alumni_events (id, organization_id, campus_id, name, effective_at, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "alumni-event-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO mentorships (id, organization_id, campus_id, name, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "mentorship-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO job_board_posts (id, organization_id, campus_id, name, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "job-post-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO cms_media (id, organization_id, campus_id, name, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "cms-media-a",
          "org-a",
          "campus-a",
      ...
      {
        sql: "INSERT INTO forms (id, organization_id, campus_id, name, details_json, created_at, updated_at, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        args: [
          "form-a",
          "org-a",
          "campus-a",
    ...
    await expectRejected(() =>
      client.execute({
        sql: "UPDATE cms_pages SET status = ? WHERE id = ?",
        args: ["pending", "cms-page-a"],
      }),
    );
  });
});
