...
export function IntegrationConfigForm() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const config = Object.fromEntries(["endpoint", "apiKey", "accountId", "webhookSecret"].map((key) => [key, String(data.get(key) ?? "")]).filter(([, value]) => value));
