...
export function ApplicationActions({ row }: { row: ApplicationActionRow }) {
  ...
  async function schedule() {
    const result = await scheduleAssessmentAction({ applicationId: row.id, campusId: row.campusId ?? "", assessmentType: type, scheduledAt: scheduledAt ? new Date(scheduledAt) : undefined, notes });
